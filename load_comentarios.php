...
<html lang="es">
    ...
    <body>
        <section style="text-align: center">
            ...
            <div id="fb-root"></div><script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:comments href="<?php echo $urlName;?>" num_posts="10" width="100%"></fb:comments>
        </section>
    </body>
</html>  